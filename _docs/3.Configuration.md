...
If you want to customize your routes, you can change `route enabled ` settings to false, then use below routes with example.
### Customer route urls with sample
```php
Route::group(['prefix'=>'logs','middleware'=>'developper'],function(){
